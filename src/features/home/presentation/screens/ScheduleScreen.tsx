    ...
    try {
      ...
      Alert.alert(
        ...
        err instanceof Error
          ? err.message
          : 'Não foi possível marcar como tomado'
      );
    }
  };
            ...
            <View style={styles.medicineList}>
              {expandedMedicineList.map((item, index) => (
                <MedicationScheduleRow
                  ...
                  onMarkAsTaken={() =>
                    handleMarkAsTaken(item.medicine.id, item.scheduledTime)
                  }
                  onPostponeDose={() =>
                    handlePostponeDose(item.medicine, item.scheduledTime)
                  }
                  onSkipDose={() =>
                    handleSkipDose(item.medicine.id, item.scheduledTime)
                  }
