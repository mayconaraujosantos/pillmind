...
export interface ResponsiveSpacingSystem {
  ...
  paddingHorizontal: (value: keyof typeof spacing | number) => Pick<ViewStyle, 'paddingHorizontal'>;
  paddingVertical: (value: keyof typeof spacing | number) => Pick<ViewStyle, 'paddingVertical'>;
  marginHorizontal: (value: keyof typeof spacing | number) => Pick<ViewStyle, 'marginHorizontal'>;
  marginVertical: (value: keyof typeof spacing | number) => Pick<ViewStyle, 'marginVertical'>;
...
export const useResponsiveSpacing = (): ResponsiveSpacingSystem => {
  ...
  // Funções principais
  const pad = (value: keyof typeof spacing | number) => getResponsiveValue(value);
  const margin = (value: keyof typeof spacing | number) => getResponsiveValue(value);
  const gap = (value: keyof typeof spacing | number) => getResponsiveValue(value);
